...
$config = array(
  'debug'                   => FALSE,
  'rpc_user'                => 'vi ~/.litecoin/litecoin.conf fill info here',
  'rpc_pass'                => 'vi ~/.litecoin/litecoin.conf fill info here',
  'rpc_host'                => 'localhost',
  'rpc_port'                => '9332',
  'rpc_ssl'                 => FALSE,
  'rpc_ssl_ca'              => NULL,
  'cache_file'              => '/tmp/litecoind-status.cache',
  'max_cache_time'          => 300,
  'nocache_whitelist'       => array('127.0.0.1'),
  'admin_email'             => 'admin@domain.net',
  'display_donation_text'   => TRUE,
  'donation_address'        => 'LZUCWDPDH3t4QbmgUYFYBJzbxKWaMnuEDm',
